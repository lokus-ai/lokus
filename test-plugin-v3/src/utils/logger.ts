...
/**
 * Enhanced logger utility for test-plugin-v3
 */
export class TestPluginV3Logger {
  private logger: SDKLogger;
  private prefix: string;

  constructor(logger: SDKLogger, prefix = 'test-plugin-v3') {
    this.logger = logger;
    this.prefix = prefix;
  }
   ...
   */
  child(childPrefix: string): TestPluginV3Logger {
    return new TestPluginV3Logger(this.logger, `${this.prefix}:${childPrefix}`);
  }
