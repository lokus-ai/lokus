 ...
 *
 * Creates a temp workspace with test files for browser-based E2E testing.
 * The workspace path is stored in a file that tests can read.
 *
 * Tests run in browser with testMode=true, which bypasses Tauri validation.
 * This allows testing the UI without requiring the Tauri backend.
 */
