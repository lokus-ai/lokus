-- Repair a missing prerequisite of handle_new_user_tier(), which is installed
-- by 20260308000000_credit_ledger.sql. This is additive and preserves users.
...
-- Backfill identities that predate this repair. The signup trigger handles new
