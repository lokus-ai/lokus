...
describe('TemplateLoops', () => {
  ...
  describe('processTemplate - nested loops', () => {
    it('should process nested loops with direct variable access', () => {
      // Note: Nested loops with this.items require complex variable scoping
      // This test shows the current supported pattern
    ...
    it('should handle multiple independent loops', () => {
      const template = '{{#each items1}}{{this}} {{/each}}| {{#each items2}}{{this}} {{/each}}';
      const variables = {
        items1: ['a', 'b'],
        items2: ['x', 'y']
      };
