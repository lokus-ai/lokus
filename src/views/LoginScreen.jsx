...
export default function LoginScreen() {
  const { signInWithEmail, signUpWithEmail, signInWithGoogle, signInWithApple, resetPassword, continueAsGuest, isLoading } = useAuth();
        ...
        {mode !== 'reset' && (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-app-border bg-app-panel hover:bg-app-bg-secondary transition-colors disabled:opacity-50 mt-3"
            >
