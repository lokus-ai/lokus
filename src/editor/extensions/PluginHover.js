/**
 * Plugin Hover
 * Wires plugin-registered hover providers to the ProseMirror editor.
 */
...
/**
 * Creates the PluginHover ProseMirror plugin.
 *
 * @returns {Plugin}
 */
export function createPluginHoverPlugin() {
  return new Plugin({
...
export default createPluginHoverPlugin
