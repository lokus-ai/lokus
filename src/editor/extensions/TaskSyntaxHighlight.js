...
/**
 * Creates the TaskSyntaxHighlight ProseMirror plugin.
 *
 * Visually highlights task syntax (!task and @task[board]) in the editor.
 *
 * @returns {Plugin}
 */
export function createTaskSyntaxHighlightPlugin() {
  return new Plugin({
...
export default createTaskSyntaxHighlightPlugin
