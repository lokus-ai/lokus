...
vi.mock("./ui/context-menu", () => ({
  ContextMenu: ({ children, ...props }) => {
    ...
    return (
      <div data-testid="context-menu" {...safeProps}>
        {children}
      </div>
    );
  },
  ...
  ContextMenuContent: ({ children, ...props }) => {
    const { asChild, ...safeProps } = props;
    return (
      <div data-testid="context-menu-content" {...safeProps}>
        {children}
      </div>
    );
  },
  ...
  ContextMenuSub: ({ children, ...props }) => {
    const { asChild, ...safeProps } = props;
    return (
      <div data-testid="context-menu-sub" {...safeProps}>
        {children}
      </div>
    );
  },
  ContextMenuSubTrigger: ({ children, ...props }) => {
    const { asChild, ...safeProps } = props;
    return (
      <div data-testid="context-menu-sub-trigger" {...safeProps}>
        {children}
      </div>
    );
  },
  ContextMenuSubContent: ({ children, ...props }) => {
    const { asChild, ...safeProps } = props;
    return (
      <div data-testid="context-menu-sub-content" {...safeProps}>
        {children}
      </div>
    );
  },
  ContextMenuShortcut: ({ children, ...props }) => {
    const { asChild, ...safeProps } = props;
    return (
      <span data-testid="context-menu-shortcut" {...safeProps}>
        {children}
      </span>
    );
  },
...
describe("EditorContextMenu", () => {
  ...
  it("should disable cut and copy when no selection", () => {
    ...
    expect(cutButton.closest("[data-disabled]")).toHaveAttribute(
      "data-disabled",
    );

    expect(copyButton.closest("[data-disabled]")).toHaveAttribute(
      "data-disabled",
    );
  });
  ...
  it("should disable undo when canUndo is false", () => {
    ...
    expect(undoButton.closest("[data-disabled]")).toHaveAttribute(
      "data-disabled",
    );
  });
