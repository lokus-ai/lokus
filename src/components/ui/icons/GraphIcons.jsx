...
/**
 * Modern SVG icon components for the graph view
 * Designed to match Obsidian's clean, professional aesthetic
 */
...
export const RefreshIcon = ({ size = 16, className = '' }) => (
  ...
  >
    ...
    <path d="m20.49,9a9,9,0,0,0-17.5,3.5" />
    <path d="m3.51,15a9,9,0,0,0,17.5-3.5" />
  </svg>
);

export const CenterIcon = ({ size = 16, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChartIcon = ({ size = 16, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
