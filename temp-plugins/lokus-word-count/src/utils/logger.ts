...
/**
 * Enhanced logger utility for lokus-word-count
 */
export class LokusWordCountLogger {
  private logger: SDKLogger;
  private prefix: string;

  constructor(logger: SDKLogger, prefix = 'lokus-word-count') {
    this.logger = logger;
    this.prefix = prefix;
  }
   ...
   */
  child(childPrefix: string): LokusWordCountLogger {
    return new LokusWordCountLogger(this.logger, `${this.prefix}:${childPrefix}`);
  }
